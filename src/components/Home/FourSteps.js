        ...
        <div className="four-steps__background-for-step-by-step">
          <div className="four-steps__step-by-step-container">
            <div className="step-by-step-container__each-step-container">
              <div className="each-step-container__graphic each-step-container__graphic--graph1"></div>
            ...
            <div className="step-by-step-container__each-step-container">
              <div className="each-step-container__graphic each-step-container__graphic--graph2"></div>
              <div className="each-step-container__action-title">Spakuj je</div>
              <div className="each-step-container__action-description">
                skorzystaj z worków na śmieci
              </div>
            </div>
            <div className="step-by-step-container__each-step-container">
              <div className="each-step-container__graphic each-step-container__graphic--graph3"></div>
              <div className="each-step-container__action-title">
            ...
            <div className="step-by-step-container__each-step-container">
              <div className="each-step-container__graphic each-step-container__graphic--graph4"></div>
              <div className="each-step-container__action-title">
                Zamów kuriera
              </div>
              <div className="each-step-container__action-description">
