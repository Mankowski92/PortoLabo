  ...
  useEffect(() => {
    fetch(`https://api.jsonbin.io/b/5e69461fe835bb6a77a18247/7`, {
      ...
      headers: {
        ...
        "secret-key":
          "$2b$10$u8DPHjDCkFgde26MlWEb3O7/ERBULwxzQHDBlS3.HL3Zok7YPW4cC"
      }
    })
      .then(response => {
        if (response.ok) {
  ...
  return (
    <div className="entity-container">
      <div className="entity-name-and-description">
        <div className="entity-name-and-description__name">
          {" "}
          {data.foundations[0].name}
        </div>
        <div className="entity-name-and-description__description">
          {data.foundations[0].description}
        </div>
      </div>
